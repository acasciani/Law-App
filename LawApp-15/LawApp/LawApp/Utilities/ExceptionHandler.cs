            ...
            try
            {
                ...
                switch (priority)
                {
                    case ExceptionPriority.Urgent:
                        To = "lawapp15+EH_Urgent@gmail.com";
                        mailpriority = MailPriority.High;
                        break;
                    case ExceptionPriority.High:
                        To = "lawapp15+EH_High@gmail.com";
                        mailpriority = MailPriority.High;
                        break;
                    case ExceptionPriority.Medium:
                        To = "lawapp15+EH_Mid@gmail.com";
                        break;
                    default:
                        To = "lawapp15+EH_Low@gmail.com";
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("AKIAIYOQZJFKMD2NMNAQ", "AmEXNP8gvyzcmy3Tb1phZdXnjfieZTUEs4pu17v4FPRY");
                    ...
                    message.From = new MailAddress("lawapp15@gmail.com");
                    client.Send(message);
                }
            }
            catch (Exception ex2)
