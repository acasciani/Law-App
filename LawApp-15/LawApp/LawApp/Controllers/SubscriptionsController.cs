...
{
    /// <summary>
    /// Web API Controller for Subscriptions entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class SubscriptionsController : OpenAccessBaseApiController<LawAppModel.Subscription, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public SubscriptionsController(IOpenAccessBaseRepository<LawAppModel.Subscription , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.Subscription Get(Int32 id)
        {
            LawAppModel.Subscription entity = repository.GetBy(l => l.SubscriptionID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.Subscription entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.Subscription entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.Subscription>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.SubscriptionID });
