...
{
    /// <summary>
    /// Web API Controller for Permissions entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class PermissionsController : OpenAccessBaseApiController<LawAppModel.Permission, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public PermissionsController(IOpenAccessBaseRepository<LawAppModel.Permission , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.Permission Get(Int32 id)
        {
            LawAppModel.Permission entity = repository.GetBy(l => l.PermissionId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.Permission entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.Permission entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.Permission>(httpStatusCode, entityToEmbed);
