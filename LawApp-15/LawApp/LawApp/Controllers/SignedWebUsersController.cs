...
{
    /// <summary>
    /// Web API Controller for SignedWebUsers entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class SignedWebUsersController : OpenAccessBaseApiController<LawAppModel.SignedWebUser, LawAppModel.LawApp>
    {
        ...
        /// </summary>
        public SignedWebUsersController()
        {
            this.repository = new SignedWebUserRepository();
        }
        ...
        public SignedWebUsersController(IOpenAccessBaseRepository<LawAppModel.SignedWebUser , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.SignedWebUser Get(Int32 id)
        {
            LawAppModel.SignedWebUser entity = repository.GetBy(l => l.WebUserId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.SignedWebUser entity)
        {
                        if (entity == null ||
                id != entity.WebUserId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.SignedWebUser entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.SignedWebUser>(httpStatusCode, entityToEmbed);
