...
{
    /// <summary>
    /// Web API Controller for TSC_Calendars entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class TSC_CalendarsController : OpenAccessBaseApiController<LawAppModel.TSC_Calendar, LawAppModel.LawApp>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public TSC_CalendarsController()
        {
            this.repository = new TSC_CalendarRepository();
        }
        ...
        public TSC_CalendarsController(IOpenAccessBaseRepository<LawAppModel.TSC_Calendar , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.TSC_Calendar Get(Int64 id)
        {
            LawAppModel.TSC_Calendar entity = repository.GetBy(l => l.CalendarId == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, LawAppModel.TSC_Calendar entity)
        {
                        if (entity == null ||
                id != entity.CalendarId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.TSC_Calendar entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.TSC_Calendar>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.CalendarId });
