...
namespace LawAppWeb
{
    ...
    public partial class UserRolesController : OpenAccessBaseApiController<LawAppModel.UserRole, LawAppModel.LawApp>
    {
        ...
        public UserRolesController(IOpenAccessBaseRepository<LawAppModel.UserRole , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.UserRole Get(Int32 id)
        {
            LawAppModel.UserRole entity = repository.GetBy(l => l.UserRoleId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.UserRole entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.UserRole entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.UserRole>(httpStatusCode, entityToEmbed);
