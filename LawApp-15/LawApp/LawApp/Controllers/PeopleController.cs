...
{
    /// <summary>
    /// Web API Controller for People entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class PeopleController : OpenAccessBaseApiController<LawAppModel.Person, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public PeopleController(IOpenAccessBaseRepository<LawAppModel.Person , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.Person Get(Int32 id)
        {
            LawAppModel.Person entity = repository.GetBy(l => l.PersonId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.Person entity)
        {
                        if (entity == null ||
                id != entity.PersonId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.Person entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.Person>(httpStatusCode, entityToEmbed);
