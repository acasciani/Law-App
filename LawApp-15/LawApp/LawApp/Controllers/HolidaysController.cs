...
{
    /// <summary>
    /// Web API Controller for Holidays entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class HolidaysController : OpenAccessBaseApiController<LawAppModel.Holiday, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public HolidaysController(IOpenAccessBaseRepository<LawAppModel.Holiday , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.Holiday Get(Int32 id)
        {
            LawAppModel.Holiday entity = repository.GetBy(l => l.HolidayId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.Holiday entity)
        {
                        if (entity == null ||
                id != entity.HolidayId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.Holiday entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.Holiday>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.HolidayId });
