...
{
    /// <summary>
    /// Web API Controller for SubscriptionPlans entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class SubscriptionPlansController : OpenAccessBaseApiController<LawAppModel.SubscriptionPlan, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public SubscriptionPlansController(IOpenAccessBaseRepository<LawAppModel.SubscriptionPlan , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.SubscriptionPlan Get(Int32 id)
        {
            LawAppModel.SubscriptionPlan entity = repository.GetBy(l => l.SubscriptionPlanID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.SubscriptionPlan entity)
        {
                        if (entity == null ||
                id != entity.SubscriptionPlanID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.SubscriptionPlan entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.SubscriptionPlan>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.SubscriptionPlanID });
