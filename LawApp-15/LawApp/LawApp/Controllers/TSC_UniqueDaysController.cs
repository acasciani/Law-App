...
{
    /// <summary>
    /// Web API Controller for TSC_UniqueDays entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class TSC_UniqueDaysController : OpenAccessBaseApiController<LawAppModel.TSC_UniqueDays, LawAppModel.LawApp>
    {
        ...
        /// </summary>
        public TSC_UniqueDaysController()
        {
            this.repository = new TSC_UniqueDaysRepository();
        }
        ...
        public TSC_UniqueDaysController(IOpenAccessBaseRepository<LawAppModel.TSC_UniqueDays , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.TSC_UniqueDays Get(Int64 id)
        {
            LawAppModel.TSC_UniqueDays entity = repository.GetBy(l => l.UniqueDayId == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, LawAppModel.TSC_UniqueDays entity)
        {
                        if (entity == null ||
                id != entity.UniqueDayId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.TSC_UniqueDays entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.TSC_UniqueDays>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.UniqueDayId });
