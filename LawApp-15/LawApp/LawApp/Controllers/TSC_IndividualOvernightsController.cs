...
{
    /// <summary>
    /// Web API Controller for TSC_IndividualOvernights entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class TSC_IndividualOvernightsController : OpenAccessBaseApiController<LawAppModel.TSC_IndividualOvernight, LawAppModel.LawApp>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public TSC_IndividualOvernightsController()
        {
            this.repository = new TSC_IndividualOvernightRepository();
        }
        ...
        public TSC_IndividualOvernightsController(IOpenAccessBaseRepository<LawAppModel.TSC_IndividualOvernight , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.TSC_IndividualOvernight Get(Int64 id)
        {
            LawAppModel.TSC_IndividualOvernight entity = repository.GetBy(l => l.IndividualOvernightId == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, LawAppModel.TSC_IndividualOvernight entity)
        {
                        if (entity == null ||
                id != entity.IndividualOvernightId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.TSC_IndividualOvernight entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.TSC_IndividualOvernight>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.IndividualOvernightId });
