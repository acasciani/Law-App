...
{
    /// <summary>
    /// Web API Controller for Applications entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class ApplicationsController : OpenAccessBaseApiController<LawAppModel.Application, LawAppModel.LawApp>
    {
        /// <summary>
        ...
        public ApplicationsController(IOpenAccessBaseRepository<LawAppModel.Application , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.Application Get(Int32 id)
        {
            LawAppModel.Application entity = repository.GetBy(l => l.ApplicationId == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.Application entity)
        {
                        if (entity == null ||
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.Application entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.Application>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.ApplicationId });
