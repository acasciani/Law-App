...
{
    /// <summary>
    /// Web API Controller for TSC_Breaks entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class TSC_BreaksController : OpenAccessBaseApiController<LawAppModel.TSC_Break, LawAppModel.LawApp>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public TSC_BreaksController()
        {
            this.repository = new TSC_BreakRepository();
        }
        ...
        public TSC_BreaksController(IOpenAccessBaseRepository<LawAppModel.TSC_Break , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.TSC_Break Get(Int64 id)
        {
            LawAppModel.TSC_Break entity = repository.GetBy(l => l.BreakId == id);
        ...
        public virtual HttpResponseMessage Put(Int64 id, LawAppModel.TSC_Break entity)
        {
                        if (entity == null ||
                id != entity.BreakId)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.TSC_Break entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.TSC_Break>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.BreakId });
