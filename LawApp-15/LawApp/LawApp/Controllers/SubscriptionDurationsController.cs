...
{
    /// <summary>
    /// Web API Controller for SubscriptionDurations entity defined in LawAppModel.LawApp data model
    /// </summary>
    public partial class SubscriptionDurationsController : OpenAccessBaseApiController<LawAppModel.SubscriptionDuration, LawAppModel.LawApp>
    {
        /// <summary>
        /// Constructor used by the Web API infrastructure.
        /// </summary>
        public SubscriptionDurationsController()
        {
            this.repository = new SubscriptionDurationRepository();
        }
        ...
        public SubscriptionDurationsController(IOpenAccessBaseRepository<LawAppModel.SubscriptionDuration , LawAppModel.LawApp> repository)
        {
        ...
        public virtual LawAppModel.SubscriptionDuration Get(Int32 id)
        {
            LawAppModel.SubscriptionDuration entity = repository.GetBy(l => l.SubscriptionDurationID == id);
        ...
        public virtual HttpResponseMessage Put(Int32 id, LawAppModel.SubscriptionDuration entity)
        {
                        if (entity == null ||
                id != entity.SubscriptionDurationID)
        ...
        protected override HttpResponseMessage CreateResponse(HttpStatusCode httpStatusCode, LawAppModel.SubscriptionDuration entityToEmbed)
        {
            HttpResponseMessage response = Request.CreateResponse<LawAppModel.SubscriptionDuration>(httpStatusCode, entityToEmbed);

            string uri = Url.Link("DefaultApi", new { id = entityToEmbed.SubscriptionDurationID });
