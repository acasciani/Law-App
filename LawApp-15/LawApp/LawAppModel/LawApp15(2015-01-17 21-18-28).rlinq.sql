...
CREATE TABLE [Application] (
    [ApplicationId] int NOT NULL,           -- _applicationId
...
CREATE TABLE [SignedWebUser] (
    ...
    [ModificationDate] datetime NOT NULL,   -- _modificationDate
    [UserPassword] varchar(255) NULL,       -- _userPassword
    [WebUserId] int NOT NULL,               -- _webUserId
...
CREATE TABLE [UserRole] (
    ...
    [UserRoleId] int NOT NULL,              -- _userRoleId
