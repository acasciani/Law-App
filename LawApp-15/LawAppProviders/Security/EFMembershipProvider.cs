...
namespace SmartSoft.EFProviders.Web.Security
{
    ...
    public class EFMembershipProvider : MembershipProvider
    {
        ...
        /// <returns></returns>
        public static bool CheckUser(string username, string applicationName, EFDataModelEntities context)
        {
        ...
        private User GetUser(Expression<Func<User, bool>> query, EFDataModelEntities context)
        {
